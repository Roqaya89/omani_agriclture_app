...
import 'package:omani_agriculture_app/screens/Admin/categories/main_categories_screen.dart';
import 'package:omani_agriculture_app/screens/Admin/products/main_products_screen.dart';
import 'package:omani_agriculture_app/screens/Admin/users/main_users_view_screen.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 1,
            backgroundColor: primaryColor,//primaryColor1,
            title: Image.asset('assets/images/logo.png', fit: BoxFit.scaleDown,width: 100,height: 30,),
            centerTitle: true,
          ),
                ...
                child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 20,),
                        Text('Welcome Former', style: TextStyle(color: whiteColor,fontSize: 20, fontWeight: FontWeight.w700),),
                      ],)
                ),
              ),
