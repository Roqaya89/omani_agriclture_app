                ...
                Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(
                          radius: 50,
                          backgroundImage: AssetImage( 'assets/images/agri.jpg'),
                        ),
                      ],
                    )),
          ...
          Padding(
            ...
            child: ListTile(
              ...
              leading: Container(
                ...
                width: 30,
                height: 30,//devSize.height*0.05,
                child: Image.asset('assets/images/field.png',height: 30,width: 30,fit: BoxFit.scaleDown,),
              ),
              trailing: Icon(
                Icons.arrow_forward_ios, color: Colors.black,size: 15,
              ),
              title:  Text('Monitoring', style: body4Black),
              onTap: () async {
                Navigator.push(
                  context,
                  PageRouteBuilder(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () async {
                      String phoneNumber = '+96898970092';
                      String message = '+96898970092';
                      ...
                      try {
                        ...
                        if (await canLaunch('whatsapp://send?phone=$phoneNumber&text=${Uri.encodeFull(message)}'))
                        {
                          ...
                          throw 'Could not launch https://api.whatsapp.com/send/?phone=+96898970092';
                        }
